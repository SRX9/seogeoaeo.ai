 ...
 * Used as the `skeleton` fallback for `<Section>` while a query is loading.
 */
...
/** Card surface frame matching the app's `rounded-xl border bg-surface p-4`. */
...
/** Grid of stat tiles — matches `DashboardKpis` / the agent-card tile grid. */
