...
const CAPABILITIES: Record<IntegrationProviderId, readonly ConnectorCapability[]> = {
  ...
  qiita: ["article.create", "article.update"],
  beehiiv: ["article.create", "article.update"],
  writeas: ["article.create", "article.update"],
  paragraph: ["article.create", "article.update"],
  buttondown: ["article.create", "article.update"],
  medium: [],
  reddit: [],
  x_post: [],
  x_article: [],
