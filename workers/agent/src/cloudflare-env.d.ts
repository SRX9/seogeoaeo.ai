/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=AgentEnv src/cloudflare-env.d.ts` (hash: e246dffd31270abe87b5b3c40855bf7c)
// Runtime types generated with workerd@1.20260625.1 2026-06-05 
interface __BaseEnv_AgentEnv {
	EMAIL: SendEmail;
	APP_ORIGIN: "https://seogeoaeo.ai";
	APP: Fetcher /* seo-ai */;
	AGENT_WORKFLOW: Workflow<Parameters<import("./index").DailyBrandWorkflow['run']>[0]['payload']>;
	SETUP_WORKFLOW: Workflow<Parameters<import("./index").SetupRunWorkflow['run']>[0]['payload']>;
	AUDIT_WORKFLOW: Workflow<Parameters<import("./index").AuditRunWorkflow['run']>[0]['payload']>;
	MUTATION_WORKFLOW: Workflow<Parameters<import("./index").ConnectorMutationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
	}
	interface Env extends __BaseEnv_AgentEnv {}
}
interface AgentEnv extends __BaseEnv_AgentEnv {}
